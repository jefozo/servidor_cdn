class Login{
    ...
    static login=(callback_ok,callback_nao_ok,config)=>{
        ...
        this.estilocss=
        ".fundoLogin{display: flex; justify-content: center; align-items: center; width: 100%; height: 100%; position: absolute; top: 0px; left: 0px; background-color: rgba(0, 0, 0, 0.75); box-sizing: border-box;}"+
        ".baseLogin{display: flex; justify-content: center; align-items: stretch; width: 60%; height: 250px; box-sizing: inherit;}"+
        ".elementosLogin{display: flex; justify-content: center; align-items: flex-start; flex-direction: column; width: 60%; background-color: aqua; padding: 10px; border-radius: 10px 0px 0px 10px; box-sizing: inherit;}"+
        ".logoLogin{display: flex; justify-content: center; align-items: center; background-color: bisque; padding: 10px; border-radius: 0px 10px 10px 0px; box-sizing: inherit;}"+
        ".logoLogin img{width: contain; height: 100%; border-radius: 10px; box-sizing: inherit;}"+
        ".campoLogin{display: flex; justify-content: flex-start; align-items: stretch; width: 100%; flex-direction: column; margin-bottom: 10px;}"+
        ".campoLogin label{font-size: 20px;}"+
        ".campoLogin input{font-size: 20px; padding: 10px; background-color: white; border-radius: 10px;}"+
        ".botoesLogin{display: flex; justify-content: space-around; align-items: center; width: 100%; box-sizing: inherit;}"+
        `.botoesLogin button{cursor: pointer; background-color:#${this.config.cor}; color: aliceblue; border-radius: 10px; padding: 10px; width: 100%; margin: 0px 10px; box-sizing: inherit};`
        ...
        imgLogoLogin.setAttribute("title","cliente");
